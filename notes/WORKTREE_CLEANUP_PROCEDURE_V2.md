...
- The main repo directory is accessible at `/home/pcalnon/Development/python/Juniper/juniper-cascor-client`
...
# Main repo
MAIN_REPO="/home/pcalnon/Development/python/Juniper/juniper-cascor-client"
```
...
gh pr create --repo pcalnon/juniper-cascor-client --base main --head "$OLD_BRANCH" \
